...
const CACHE_NAME = 'cyber-labs.solutions-1610470690788';
const SW_SUPPORTED_PROTOCOL_REGEX = /http(s?):/;
const pageUrls = JSON.parse('["/","/services","/contact-us"]');
const staticAssets = JSON.parse('["https://img1.wsimg.com/poly/v2/polyfill.min.js?unknown=polyfill&flags=gated&features=default%2Cfetch%2CArray.prototype.%40%40iterator%2CArray.prototype.find%2CArray.prototype.findIndex%2CFunction.name%2CNumber.isFinite%2CPromise%2CString.prototype.repeat%2CMath.sign%2CMath.trunc%2CArray.prototype.includes%2CObject.entries%2CObject.values%2CObject.is%2CIntersectionObserver%2CIntl.~locale.en-US","//img1.wsimg.com/blobby/go/05b471b0-27bf-4535-83a5-5c49e7259ee8/gpub/aebe4d170e34c8df/script.js","//img1.wsimg.com/ceph-p3-01/website-builder-data-prod/static/widgets/UX.3.75.3.js","//fonts.googleapis.com/css?family=Bitter:700&display=swap","https://fonts.googleapis.com/css?family=Yeseva+One&display=swap"]');
const networkOnlyUrls = JSON.parse('["https://api.ola.godaddy.com","https://05b471b0-27bf-4535-83a5-5c49e7259ee8.onlinestore.godaddy.com","https://img.secureserver.net/t/1/tl/event","https://img.test-secureserver.net/t/1/tl/event","https://www.google-analytics.com/collect","https://calendar.apps.dev-secureserver.net","https://calendar.apps.test-secureserver.net","https://calendar.apps.secureserver.net"]');
const networkOnlyUrlsRegex = JSON.parse('["cyber-labs.solutions/m/api/.*","cyber-labs.solutions(?:/.*)?/ola/services/.*","cyber-labs.solutions/ola/meetings/.*","securepay.godaddy.com/api/apps/ola/accounts/.*"]').map(regexString => new RegExp(regexString));
const networkThenCacheUrls = JSON.parse('["https://blog.apps.secureserver.net/v1/website/05b471b0-27bf-4535-83a5-5c49e7259ee8/feed/post/","https://blog.apps.secureserver.net/v1/website/05b471b0-27bf-4535-83a5-5c49e7259ee8/feed"]');
const networkThenCacheUrlsRegex = JSON.parse('["cyber-labs.solutions(?:/.*)?/f/.*"]').map(regexString => new RegExp(regexString));
...
function preCacheResources() {
    return caches.open(CACHE_NAME).then(function (cache) {
        ...
        cache.addAll(pageUrls);
        // Pre-cache all static assets by keeping them as installation dependency
